...
from mlagentsdev.envs import UnityException, AllBrainInfo, BrainInfo
from mlagentsdev.trainers import ActionInfo
...
class Trainer(object):
    """This class is the base class for the mlagentsdev.envs.trainers"""
