...
from mlagentsdev.trainers.trainer_controller import TrainerController
from mlagentsdev.trainers.exception import TrainerError
from mlagentsdev.trainers import MetaCurriculumError, MetaCurriculum
...
from mlagentsdev.envs.subprocess_environment import SubprocessUnityEnvironment
    ...
    for f in glob.glob('/{docker_target_name}/*'.format(
        ...
        if env_path in f:
            try:
                ...
                logging.getLogger('mlagentsdev.trainers').info(e)
...
def main():
    ...
    _USAGE = '''
    Usage:
      mlagentsdev-learn <trainer-config-path> [options]
      mlagentsdev-learn --help
    ...
    trainer_logger = logging.getLogger('mlagentsdev.trainers')
    env_logger = logging.getLogger('mlagentsdev.envs')
