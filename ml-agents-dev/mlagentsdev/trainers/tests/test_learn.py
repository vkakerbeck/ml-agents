...
from mlagentsdev.trainers import learn, TrainerController
...
@patch('mlagentsdev.trainers.learn.SubprocessUnityEnvironment')
@patch('mlagentsdev.trainers.learn.create_environment_factory')
@patch('mlagentsdev.trainers.learn.load_config')
