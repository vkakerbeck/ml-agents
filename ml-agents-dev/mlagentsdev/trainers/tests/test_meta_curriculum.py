...
from mlagentsdev.trainers.exception import MetaCurriculumError
...
@patch('mlagentsdev.trainers.Curriculum.get_config', return_value={})
@patch('mlagentsdev.trainers.Curriculum.__init__', return_value=None)
...
@patch('mlagentsdev.trainers.Curriculum')
@patch('mlagentsdev.trainers.Curriculum')
