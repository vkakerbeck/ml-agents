...
from mlagentsdev.trainers.ppo.trainer import discount_rewards
from mlagentsdev.trainers.ppo.policy import PPOPolicy
from mlagentsdev.envs import UnityEnvironment
from mlagentsdev.envs.mock_communicator import MockCommunicator
...
@mock.patch('mlagentsdev.envs.UnityEnvironment.executable_launcher')
@mock.patch('mlagentsdev.envs.UnityEnvironment.get_communicator')
