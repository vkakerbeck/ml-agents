...
from mlagentsdev.envs.communicator_objects import custom_action_pb2 as mlagentsdev_dot_envs_dot_communicator__objects_dot_custom__action__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='mlagentsdev/envs/communicator_objects/agent_action_proto.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_options=_b('\252\002\034mlagentsdev.CommunicatorObjects'),
  serialized_pb=_b('\n;mlagentsdev/envs/communicator_objects/agent_action_proto.proto\x12\x14\x63ommunicator_objects\x1a\x36mlagentsdev/envs/communicator_objects/custom_action.proto\"\x9c\x01\n\x10\x41gentActionProto\x12\x16\n\x0evector_actions\x18\x01 \x03(\x02\x12\x14\n\x0ctext_actions\x18\x02 \x01(\t\x12\x10\n\x08memories\x18\x03 \x03(\x02\x12\r\n\x05value\x18\x04 \x01(\x02\x12\x39\n\rcustom_action\x18\x05 \x01(\x0b\x32\".communicator_objects.CustomActionB\x1f\xaa\x02\x1cmlagentsdev.CommunicatorObjectsb\x06proto3')
  ,
  dependencies=[mlagentsdev_dot_envs_dot_communicator__objects_dot_custom__action__pb2.DESCRIPTOR,])
...
_AGENTACTIONPROTO.fields_by_name['custom_action'].message_type = mlagentsdev_dot_envs_dot_communicator__objects_dot_custom__action__pb2._CUSTOMACTION
...
AgentActionProto = _reflection.GeneratedProtocolMessageType('AgentActionProto', (_message.Message,), dict(
  ...
  __module__ = 'mlagentsdev.envs.communicator_objects.agent_action_proto_pb2'
