...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='mlagentsdev/envs/communicator_objects/engine_configuration_proto.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_options=_b('\252\002\034mlagentsdev.CommunicatorObjects'),
  serialized_pb=_b('\nCmlagentsdev/envs/communicator_objects/engine_configuration_proto.proto\x12\x14\x63ommunicator_objects\"\x95\x01\n\x18\x45ngineConfigurationProto\x12\r\n\x05width\x18\x01 \x01(\x05\x12\x0e\n\x06height\x18\x02 \x01(\x05\x12\x15\n\rquality_level\x18\x03 \x01(\x05\x12\x12\n\ntime_scale\x18\x04 \x01(\x02\x12\x19\n\x11target_frame_rate\x18\x05 \x01(\x05\x12\x14\n\x0cshow_monitor\x18\x06 \x01(\x08\x42\x1f\xaa\x02\x1cmlagentsdev.CommunicatorObjectsb\x06proto3')
)
...
EngineConfigurationProto = _reflection.GeneratedProtocolMessageType('EngineConfigurationProto', (_message.Message,), dict(
  ...
  __module__ = 'mlagentsdev.envs.communicator_objects.engine_configuration_proto_pb2'
