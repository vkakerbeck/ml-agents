...
from mlagentsdev.envs.communicator_objects import resolution_proto_pb2 as mlagentsdev_dot_envs_dot_communicator__objects_dot_resolution__proto__pb2
from mlagentsdev.envs.communicator_objects import space_type_proto_pb2 as mlagentsdev_dot_envs_dot_communicator__objects_dot_space__type__proto__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='mlagentsdev/envs/communicator_objects/brain_parameters_proto.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_options=_b('\252\002\034mlagentsdev.CommunicatorObjects'),
  serialized_pb=_b('\n?mlagentsdev/envs/communicator_objects/brain_parameters_proto.proto\x12\x14\x63ommunicator_objects\x1a\x39mlagentsdev/envs/communicator_objects/resolution_proto.proto\x1a\x39mlagentsdev/envs/communicator_objects/space_type_proto.proto\"\xd4\x02\n\x14\x42rainParametersProto\x12\x1f\n\x17vector_observation_size\x18\x01 \x01(\x05\x12\'\n\x1fnum_stacked_vector_observations\x18\x02 \x01(\x05\x12\x1a\n\x12vector_action_size\x18\x03 \x03(\x05\x12\x41\n\x12\x63\x61mera_resolutions\x18\x04 \x03(\x0b\x32%.communicator_objects.ResolutionProto\x12\"\n\x1avector_action_descriptions\x18\x05 \x03(\t\x12\x46\n\x18vector_action_space_type\x18\x06 \x01(\x0e\x32$.communicator_objects.SpaceTypeProto\x12\x12\n\nbrain_name\x18\x07 \x01(\t\x12\x13\n\x0bis_training\x18\x08 \x01(\x08\x42\x1f\xaa\x02\x1cmlagentsdev.CommunicatorObjectsb\x06proto3')
  ,
  dependencies=[mlagentsdev_dot_envs_dot_communicator__objects_dot_resolution__proto__pb2.DESCRIPTOR,mlagentsdev_dot_envs_dot_communicator__objects_dot_space__type__proto__pb2.DESCRIPTOR,])
...
_BRAINPARAMETERSPROTO.fields_by_name['camera_resolutions'].message_type = mlagentsdev_dot_envs_dot_communicator__objects_dot_resolution__proto__pb2._RESOLUTIONPROTO
_BRAINPARAMETERSPROTO.fields_by_name['vector_action_space_type'].enum_type = mlagentsdev_dot_envs_dot_communicator__objects_dot_space__type__proto__pb2._SPACETYPEPROTO
...
BrainParametersProto = _reflection.GeneratedProtocolMessageType('BrainParametersProto', (_message.Message,), dict(
  ...
  __module__ = 'mlagentsdev.envs.communicator_objects.brain_parameters_proto_pb2'
