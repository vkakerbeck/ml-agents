...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='mlagentsdev/envs/communicator_objects/command_proto.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_options=_b('\252\002\034mlagentsdev.CommunicatorObjects'),
  serialized_pb=_b('\n6mlagentsdev/envs/communicator_objects/command_proto.proto\x12\x14\x63ommunicator_objects*-\n\x0c\x43ommandProto\x12\x08\n\x04STEP\x10\x00\x12\t\n\x05RESET\x10\x01\x12\x08\n\x04QUIT\x10\x02\x42\x1f\xaa\x02\x1cmlagentsdev.CommunicatorObjectsb\x06proto3')
)
