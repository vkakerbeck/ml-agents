...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='mlagentsdev/envs/communicator_objects/custom_action.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_options=_b('\252\002\034mlagentsdev.CommunicatorObjects'),
  serialized_pb=_b('\n6mlagentsdev/envs/communicator_objects/custom_action.proto\x12\x14\x63ommunicator_objects\"\x0e\n\x0c\x43ustomActionB\x1f\xaa\x02\x1cmlagentsdev.CommunicatorObjectsb\x06proto3')
)
...
CustomAction = _reflection.GeneratedProtocolMessageType('CustomAction', (_message.Message,), dict(
  ...
  __module__ = 'mlagentsdev.envs.communicator_objects.custom_action_pb2'
