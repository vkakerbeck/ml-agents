...
from mlagentsdev.envs.communicator_objects import agent_action_proto_pb2 as mlagentsdev_dot_envs_dot_communicator__objects_dot_agent__action__proto__pb2
from mlagentsdev.envs.communicator_objects import environment_parameters_proto_pb2 as mlagentsdev_dot_envs_dot_communicator__objects_dot_environment__parameters__proto__pb2
from mlagentsdev.envs.communicator_objects import command_proto_pb2 as mlagentsdev_dot_envs_dot_communicator__objects_dot_command__proto__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='mlagentsdev/envs/communicator_objects/unity_rl_input.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_options=_b('\252\002\034mlagentsdev.CommunicatorObjects'),
  serialized_pb=_b('\n7mlagentsdev/envs/communicator_objects/unity_rl_input.proto\x12\x14\x63ommunicator_objects\x1a;mlagentsdev/envs/communicator_objects/agent_action_proto.proto\x1a\x45mlagentsdev/envs/communicator_objects/environment_parameters_proto.proto\x1a\x36mlagentsdev/envs/communicator_objects/command_proto.proto\"\xb4\x03\n\x0cUnityRLInput\x12K\n\ragent_actions\x18\x01 \x03(\x0b\x32\x34.communicator_objects.UnityRLInput.AgentActionsEntry\x12P\n\x16\x65nvironment_parameters\x18\x02 \x01(\x0b\x32\x30.communicator_objects.EnvironmentParametersProto\x12\x13\n\x0bis_training\x18\x03 \x01(\x08\x12\x33\n\x07\x63ommand\x18\x04 \x01(\x0e\x32\".communicator_objects.CommandProto\x1aM\n\x14ListAgentActionProto\x12\x35\n\x05value\x18\x01 \x03(\x0b\x32&.communicator_objects.AgentActionProto\x1al\n\x11\x41gentActionsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\x46\n\x05value\x18\x02 \x01(\x0b\x32\x37.communicator_objects.UnityRLInput.ListAgentActionProto:\x02\x38\x01\x42\x1f\xaa\x02\x1cmlagentsdev.CommunicatorObjectsb\x06proto3')
  ,
  dependencies=[mlagentsdev_dot_envs_dot_communicator__objects_dot_agent__action__proto__pb2.DESCRIPTOR,mlagentsdev_dot_envs_dot_communicator__objects_dot_environment__parameters__proto__pb2.DESCRIPTOR,mlagentsdev_dot_envs_dot_communicator__objects_dot_command__proto__pb2.DESCRIPTOR,])
...
_UNITYRLINPUT_LISTAGENTACTIONPROTO.fields_by_name['value'].message_type = mlagentsdev_dot_envs_dot_communicator__objects_dot_agent__action__proto__pb2._AGENTACTIONPROTO
...
_UNITYRLINPUT.fields_by_name['environment_parameters'].message_type = mlagentsdev_dot_envs_dot_communicator__objects_dot_environment__parameters__proto__pb2._ENVIRONMENTPARAMETERSPROTO
_UNITYRLINPUT.fields_by_name['command'].enum_type = mlagentsdev_dot_envs_dot_communicator__objects_dot_command__proto__pb2._COMMANDPROTO
...
UnityRLInput = _reflection.GeneratedProtocolMessageType('UnityRLInput', (_message.Message,), dict(
  ...
  ListAgentActionProto = _reflection.GeneratedProtocolMessageType('ListAgentActionProto', (_message.Message,), dict(
    ...
    __module__ = 'mlagentsdev.envs.communicator_objects.unity_rl_input_pb2'
