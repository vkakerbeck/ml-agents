...
from mlagentsdev.envs.communicator_objects import agent_info_proto_pb2 as mlagentsdev_dot_envs_dot_communicator__objects_dot_agent__info__proto__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='mlagentsdev/envs/communicator_objects/unity_rl_output.proto',
  package='communicator_objects',
  syntax='proto3',
  serialized_options=_b('\252\002\034mlagentsdev.CommunicatorObjects'),
  serialized_pb=_b('\n8mlagentsdev/envs/communicator_objects/unity_rl_output.proto\x12\x14\x63ommunicator_objects\x1a\x39mlagentsdev/envs/communicator_objects/agent_info_proto.proto\"\xa3\x02\n\rUnityRLOutput\x12\x13\n\x0bglobal_done\x18\x01 \x01(\x08\x12G\n\nagentInfos\x18\x02 \x03(\x0b\x32\x33.communicator_objects.UnityRLOutput.AgentInfosEntry\x1aI\n\x12ListAgentInfoProto\x12\x33\n\x05value\x18\x01 \x03(\x0b\x32$.communicator_objects.AgentInfoProto\x1ai\n\x0f\x41gentInfosEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\x45\n\x05value\x18\x02 \x01(\x0b\x32\x36.communicator_objects.UnityRLOutput.ListAgentInfoProto:\x02\x38\x01\x42\x1f\xaa\x02\x1cmlagentsdev.CommunicatorObjectsb\x06proto3')
  ,
  dependencies=[mlagentsdev_dot_envs_dot_communicator__objects_dot_agent__info__proto__pb2.DESCRIPTOR,])
...
_UNITYRLOUTPUT_LISTAGENTINFOPROTO.fields_by_name['value'].message_type = mlagentsdev_dot_envs_dot_communicator__objects_dot_agent__info__proto__pb2._AGENTINFOPROTO
...
UnityRLOutput = _reflection.GeneratedProtocolMessageType('UnityRLOutput', (_message.Message,), dict(
  ...
  ListAgentInfoProto = _reflection.GeneratedProtocolMessageType('ListAgentInfoProto', (_message.Message,), dict(
    ...
    __module__ = 'mlagentsdev.envs.communicator_objects.unity_rl_output_pb2'
